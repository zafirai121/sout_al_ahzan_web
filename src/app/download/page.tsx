    ...
    <div style={{ padding: '80px 40px', color: '#fff', textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', flexWrap: 'wrap' }}>
        ...
        <div style={{ width: '280px', backgroundColor: '#282828', borderRadius: '12px', padding: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <button style={{ padding: '12px 32px', borderRadius: '24px', border: 'none', background: '#1ed760', color: '#000', fontWeight: 'bold', fontSize: '16px', cursor: 'pointer' }}>تنزيل الآن</button>
        </div>
        ...
        <div style={{ width: '280px', backgroundColor: '#282828', borderRadius: '12px', padding: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <button style={{ padding: '12px 32px', borderRadius: '24px', border: 'none', background: '#fff', color: '#000', fontWeight: 'bold', fontSize: '16px', cursor: 'pointer' }}>تنزيل الآن</button>
        </div>
        ...
        <div style={{ width: '280px', backgroundColor: '#282828', borderRadius: '12px', padding: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <button style={{ padding: '12px 32px', borderRadius: '24px', border: '1px solid #727272', background: 'transparent', color: '#fff', fontWeight: 'bold', fontSize: '16px', cursor: 'pointer' }}>قريباً في المتاجر</button>
        </div>
